...
from terry.domain.terraform.workspaces.entities import Workspace, WorkspaceListOutput
from terry.domain.terraform.workspaces.services import BaseWorkspaceService

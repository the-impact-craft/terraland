...
from terraland.infrastructure.file_system.exceptions import ReadFileException, DeleteDirException, DeleteFileException
...
from terraland.presentation.cli.screens.main.containers.commands_log import (
    CommandsLog,
)
...
from terraland.presentation.cli.screens.main.containers.state_files import StateFiles
from terraland.presentation.cli.screens.main.containers.workspaces import Workspaces
from terraland.presentation.cli.screens.main.helpers import get_terraform_version, validate_work_dir
from terraland.presentation.cli.screens.main.mixins.resize_containers_watcher_mixin import ResizeContainersWatcherMixin
from terraland.presentation.cli.screens.main.mixins.system_monitoring_mixin import SystemMonitoringMixin
from terraland.presentation.cli.screens.main.mixins.terraform_action_handler_mixin import TerraformActionHandlerMixin
...
from terraland.presentation.cli.themes.arctic import arctic_theme
from terraland.presentation.cli.themes.github_dark import github_dark_theme
from terraland.settings import (
    CommandStatus,
...
class TerraLand(App, ResizeContainersWatcherMixin, TerraformActionHandlerMixin, SystemMonitoringMixin):
    """The main app for the TerraLand project."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize the TerraLand App with a specified working directory.
    ...
    def compose(self) -> ComposeResult:
        """
        Compose the user interface for the TerraLand application.
    ...
    async def on_file_select(self, message: FileSelect) -> None:
        """
        Handle the file double-clicked event in the TerraLand application.
    ...
    def on_workspaces_select_event(self, message: Workspaces.SelectEvent) -> None:
        """
        Handle the workspace change event in the TerraLand application.
